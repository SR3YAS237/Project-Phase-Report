...
# SAVE RF RESULTS
# =====================================
with open("rf_adfawd_multi.txt", "w", encoding="utf-8") as f:
...
plt.savefig("rf_adfawd_multi_confusion.png")
...
# SAVE SVM RESULTS
# =====================================
with open("svm_adfawd_multi.txt", "w", encoding="utf-8") as f:
...
plt.savefig("svm_adfawd_multi_confusion.png")
...
# SAVE DNN RESULTS
# =====================================
with open("dnn_adfawd_multi.txt", "w", encoding="utf-8") as f:
...
plt.savefig("dnn_adfawd_multi_confusion.png")
...
plt.title("ADFA-WD Multi-Class Accuracy")

plt.savefig("adfawd_multi_accuracy_comparison.png")

plt.close()

print("✅ Accuracy comparison graph saved")

print("\n🎯 ADFA-WD MULTI-CLASS CLASSIFICATION COMPLETED!")