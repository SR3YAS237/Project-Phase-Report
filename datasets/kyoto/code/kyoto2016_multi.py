...
# 1 is Normal, -1 is Unknown Attack, -2 is Known Attack
df['label'] = df['label'].replace({'1': 'Normal', '-1': 'Unknown_Attack', '-2': 'Known_Attack'})
df = df[df['label'].isin(['Normal', 'Unknown_Attack', 'Known_Attack'])]
...
# =====================================
with open("../result/kyoto2016_results_multi.txt", "w") as f:
    f.write("========== Kyoto 2016 MULTI RESULTS ==========\n\n")
...
plot_cm(confusion_matrix(y_test, y_pred_rf), "RF Confusion Matrix", "../result/kyoto2016_rf_confusion_multi.png", "Reds")
plot_cm(confusion_matrix(y_test, y_pred_svm), "SVM Confusion Matrix", "../result/kyoto2016_svm_confusion_multi.png", "Blues")
plot_cm(confusion_matrix(y_test, y_pred_nn), "DNN Confusion Matrix", "../result/kyoto2016_dnn_confusion_multi.png", "Greens")
...
plt.ylabel("Accuracy")
plt.title("Kyoto 2016 MULTI Accuracy Comparison")
plt.savefig("../result/kyoto2016_accuracy_comparison_multi.png")
plt.close()

print("✅ Graphs saved")
print("\n🎯 Kyoto 2016 MULTI EXPERIMENT COMPLETED!")
