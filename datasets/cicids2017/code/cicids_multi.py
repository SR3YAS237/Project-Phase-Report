...
df['Label'] = df['Label'].replace({
    ...
    'Web Attack � Sql Injection': 'WebAttack-SQLInjection'
})
...
# SAVE RF RESULTS
# =====================================
with open("rf_cicids_multi.txt", "w", encoding="utf-8") as f:
...
plt.savefig("rf_cicids_multi_confusion.png")
...
# SAVE SVM RESULTS
# =====================================
with open("svm_cicids_multi.txt", "w", encoding="utf-8") as f:
...
plt.savefig("svm_cicids_multi_confusion.png")
...
# SAVE DNN RESULTS
# =====================================
with open("dnn_cicids_multi.txt", "w", encoding="utf-8") as f:
...
plt.savefig("dnn_cicids_multi_confusion.png")
...
plt.title("CICIDS2017 Multi-Class Accuracy")

plt.savefig("cicids_multi_accuracy_comparison.png")

plt.close()

print("✅ Accuracy comparison graph saved")

print("\n🎯 CICIDS2017 MULTI-CLASS CLASSIFICATION COMPLETED!")