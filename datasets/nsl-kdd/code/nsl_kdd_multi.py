...
# =====================================
with open("../result/nsl_kdd_results_multi.txt", "w") as f:
    f.write("========== NSL-KDD MULTI RESULTS ==========\n\n")
...
plot_cm(confusion_matrix(y_test, y_pred_rf), "RF Confusion Matrix", "../result/nsl_kdd_rf_confusion_multi.png", "Reds")
plot_cm(confusion_matrix(y_test, y_pred_svm), "SVM Confusion Matrix", "../result/nsl_kdd_svm_confusion_multi.png", "Blues")
plot_cm(confusion_matrix(y_test, y_pred_nn), "DNN Confusion Matrix", "../result/nsl_kdd_dnn_confusion_multi.png", "Greens")
...
plt.ylabel("Accuracy")
plt.title("NSL-KDD MULTI Accuracy Comparison")
plt.savefig("../result/nsl_kdd_accuracy_comparison_multi.png")
plt.close()

print("✅ Graphs saved")
print("\n🎯 NSL-KDD MULTI EXPERIMENT COMPLETED!")
