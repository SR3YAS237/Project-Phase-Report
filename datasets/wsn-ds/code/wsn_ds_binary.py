...
df['Attack type'] = df['Attack type'].apply(lambda x: 'Normal' if x == 'Normal' else 'Attack')
...
# =====================================
with open("../result/wsn_ds_results_binary.txt", "w") as f:
    f.write("========== WSN-DS BINARY RESULTS ==========\n\n")
...
plot_cm(confusion_matrix(y_test, y_pred_rf), "RF Confusion Matrix", "../result/wsn_ds_rf_confusion_binary.png", "Reds")
plot_cm(confusion_matrix(y_test, y_pred_svm), "SVM Confusion Matrix", "../result/wsn_ds_svm_confusion_binary.png", "Blues")
plot_cm(confusion_matrix(y_test, y_pred_nn), "DNN Confusion Matrix", "../result/wsn_ds_dnn_confusion_binary.png", "Greens")
...
plt.ylabel("Accuracy")
plt.title("WSN-DS BINARY Accuracy Comparison")
plt.savefig("../result/wsn_ds_accuracy_comparison_binary.png")
plt.close()

print("✅ Graphs saved")
print("\n🎯 WSN-DS BINARY EXPERIMENT COMPLETED!")
